...
function sayhello68() {alert('今年は, ' + document.getElementById('when01').innerHTML);}
function taro68() {document.getElementById('when01').innerHTML = '西暦 2021年';}
function hanako68() {document.getElementById('when01').innerHTML = '和暦 令和3年';}